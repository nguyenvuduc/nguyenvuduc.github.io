...
var PageTransitionsFactory = function ($, options) {
"use strict";
    ...
    function getActiveSection() {
        if(location.hash === "") {
            location.hash = defaultStartPage;
...
var pages_switcher_initialize = function()
{
    window.PageTransitions = PageTransitionsFactory(jQuery);
}
